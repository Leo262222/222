  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm flex flex-col items-center animate-[scaleIn_0.2s_ease-out]">
        <button onClick={onClose} className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-gray-200 rounded-full transition-colors text-gray-500">
        ...
        <p className="text-sm text-gray-500 mb-6 text-center leading-relaxed">
          请扫描下方二维码<br/>添加客服，我们将为您连接 <span className="font-bold text-purple-700">{advisorName}</span>
        </p>
